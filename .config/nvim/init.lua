...
require('lazy').setup({
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader><leader>s', '<cmd>source ~/.config/nvim/lua/custom/plugins/customsnips.lua<CR>', { desc = 'Reload your [S]nipits' })
  ...
  },
  {
    ...
    config = function()
      vim.keymap.set('n', '<leader>nt', '<Cmd>Neotree toggle<CR>', { desc = 'Toggle showing [N]eo[T]ree' })
    end,
  },
  'tpope/vim-fugitive',
  {
